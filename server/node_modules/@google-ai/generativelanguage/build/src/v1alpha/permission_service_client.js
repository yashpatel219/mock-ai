...
class PermissionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1alpha.PermissionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.permissionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ai.generativelanguage.v1alpha.PermissionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ai.generativelanguage.v1alpha.PermissionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const permissionServiceStubMethods = ['createPermission', 'getPermission', 'listPermissions', 'updatePermission', 'deletePermission', 'transferOwnership'];
