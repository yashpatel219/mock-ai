...
class ModelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createTunedModelResponse = protoFilesRoot.lookup('.google.ai.generativelanguage.v1alpha.TunedModel');
        const createTunedModelMetadata = protoFilesRoot.lookup('.google.ai.generativelanguage.v1alpha.CreateTunedModelMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1alpha.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ai.generativelanguage.v1alpha.ModelService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ai.generativelanguage.v1alpha.ModelService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const modelServiceStubMethods = ['getModel', 'listModels', 'getTunedModel', 'listTunedModels', 'createTunedModel', 'updateTunedModel', 'deleteTunedModel'];
