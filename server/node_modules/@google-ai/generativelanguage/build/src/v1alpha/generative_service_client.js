...
class GenerativeServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1alpha.GenerativeService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.generativeServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ai.generativelanguage.v1alpha.GenerativeService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ai.generativelanguage.v1alpha.GenerativeService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const generativeServiceStubMethods = ['generateContent', 'generateAnswer', 'streamGenerateContent', 'embedContent', 'batchEmbedContents', 'countTokens', 'bidiGenerateContent'];
