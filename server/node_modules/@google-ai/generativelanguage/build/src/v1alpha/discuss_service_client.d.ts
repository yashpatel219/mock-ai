...
export declare class DiscussServiceClient {
     ...
     * @param {google.ai.generativelanguage.v1alpha.MessagePrompt} request.prompt
     ...
     *   The first element of the array is an object representing {@link protos.google.ai.generativelanguage.v1alpha.GenerateMessageResponse|GenerateMessageResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1alpha/discuss_service.generate_message.js</caption>
     * region_tag:generativelanguage_v1alpha_generated_DiscussService_GenerateMessage_async
     */
    generateMessage(request?: protos.google.ai.generativelanguage.v1alpha.IGenerateMessageRequest, options?: CallOptions): Promise<[
        protos.google.ai.generativelanguage.v1alpha.IGenerateMessageResponse,
        protos.google.ai.generativelanguage.v1alpha.IGenerateMessageRequest | undefined,
        {} | undefined
    ]>;
    generateMessage(request: protos.google.ai.generativelanguage.v1alpha.IGenerateMessageRequest, options: CallOptions, callback: Callback<protos.google.ai.generativelanguage.v1alpha.IGenerateMessageResponse, protos.google.ai.generativelanguage.v1alpha.IGenerateMessageRequest | null | undefined, {} | null | undefined>): void;
    generateMessage(request: protos.google.ai.generativelanguage.v1alpha.IGenerateMessageRequest, callback: Callback<protos.google.ai.generativelanguage.v1alpha.IGenerateMessageResponse, protos.google.ai.generativelanguage.v1alpha.IGenerateMessageRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.ai.generativelanguage.v1alpha.CountMessageTokensResponse|CountMessageTokensResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1alpha/discuss_service.count_message_tokens.js</caption>
     * region_tag:generativelanguage_v1alpha_generated_DiscussService_CountMessageTokens_async
     */
    countMessageTokens(request?: protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensRequest, options?: CallOptions): Promise<[
        protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensResponse,
        protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensRequest | undefined,
        {} | undefined
    ]>;
    countMessageTokens(request: protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensRequest, options: CallOptions, callback: Callback<protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensResponse, protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensRequest | null | undefined, {} | null | undefined>): void;
    countMessageTokens(request: protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensRequest, callback: Callback<protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensResponse, protos.google.ai.generativelanguage.v1alpha.ICountMessageTokensRequest | null | undefined, {} | null | undefined>): void;
    /**
