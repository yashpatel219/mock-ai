...
class RetrieverServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1alpha.RetrieverService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.retrieverServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ai.generativelanguage.v1alpha.RetrieverService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ai.generativelanguage.v1alpha.RetrieverService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const retrieverServiceStubMethods = ['createCorpus', 'getCorpus', 'updateCorpus', 'deleteCorpus', 'listCorpora', 'queryCorpus', 'createDocument', 'getDocument', 'updateDocument', 'deleteDocument', 'listDocuments', 'queryDocument', 'createChunk', 'batchCreateChunks', 'getChunk', 'updateChunk', 'batchUpdateChunks', 'deleteChunk', 'batchDeleteChunks', 'listChunks'];
