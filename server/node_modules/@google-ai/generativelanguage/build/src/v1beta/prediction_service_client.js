...
class PredictionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            corpusPermissionsPathTemplate: new this._gaxModule.PathTemplate('corpora/{corpus}/permissions/{permission}'),
            ...
            tunedModelPermissionsPathTemplate: new this._gaxModule.PathTemplate('tunedModels/{tuned_model}/permissions/{permission}'),
        };
        ...
        const predictLongRunningResponse = protoFilesRoot.lookup('.google.ai.generativelanguage.v1beta.PredictLongRunningResponse');
        const predictLongRunningMetadata = protoFilesRoot.lookup('.google.ai.generativelanguage.v1beta.PredictLongRunningMetadata');
        this.descriptors.longrunning = {
            predictLongRunning: new this._gaxModule.LongrunningDescriptor(this.operationsClient, predictLongRunningResponse.decode.bind(predictLongRunningResponse), predictLongRunningMetadata.decode.bind(predictLongRunningMetadata))
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.ai.generativelanguage.v1beta.PredictionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.predictionServiceStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.ai.generativelanguage.v1beta.PredictionService') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.ai.generativelanguage.v1beta.PredictionService, this._opts, this._providedCustomServicePath);
    ...
    predictLongRunning(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkPredictLongRunningProgress(name) {
